question="""<p>Let $A$ be an <b>affine plane</b> over a <b>radically integral local field</b> $F$ with residual characteristic $p$.</p>
...
print("".join([j[0] for j in (" ".join(i[:i.index("<")] for i in question.split("<b>"))[1:]).split(" ")]))
